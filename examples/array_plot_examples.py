...
fig, ax = Array.plot(arr, exculde_value=exculde_value,color_scale=color_scale[0], cmap=cmap,
                     ticks_spacing=ticks_spacing)
#%% test_plot_array_color_scale_2
color_scale_2_gamma = 0.5
fig, ax = Array.plot(arr, exculde_value=exculde_value, color_scale=color_scale[1], cmap=cmap,
                     gamma=color_scale_2_gamma, ticks_spacing=ticks_spacing)
